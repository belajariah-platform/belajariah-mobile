...
import { AdminProfileAll, AdminProfileEdit, AdminProfileInstructor, AdminTransaction } from '../../../containers'
...
const InstructorPrivateNavigation = () => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name='AdminTransaction' component={AdminTransaction} />
