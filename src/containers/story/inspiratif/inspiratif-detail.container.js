    ...
    return(
      <View style={styles.containerInspiratif}>
        <View style={styles.containerTopTitle}>
          <View>
            <Text style={styles.TitleBacaan}>{state.Title}</Text>
            <Text style={styles.TxtTime}>
              {moment(state.Created_Date).format('dddd, DD MMMM YYYY')}
            </Text>
          </View>
        </View>
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() => copyToClipboard(state.Source)}>
            <Text style={styles.TxtSourceImg}>Source : {state.Source}</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.containerWriter}>
          <Text style={styles.TxtWriter}>Oleh:</Text>
          <Text style={styles.TxtWriter}>{state.Writer}</Text>
        </View>
