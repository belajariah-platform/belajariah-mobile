                        ...
                        <View style={styles.viewStyle}>
                            ...
                            <View style={styles.containerDesc}>
                                ...
                                <View style={styles.ViewTarif}>
                                    <Text style={{...styles.textStylePrice, color: params.color_path}}>Infaq Belajar : </Text>
                                    <Text style={{...styles.textStylePrice, color: params.color_path}}>{item.Minimum_Rate == 0 ? 'Diskusikan dengan pengajar' :  'Rp' + FormatRupiah(item.Minimum_Rate)}</Text>
                                </View>
