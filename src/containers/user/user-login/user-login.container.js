...
const Login = (props) => {
  ...
  useEffect(() => {
    GoogleSignin.configure({
      ...
      webClientId: '324403427572-p0be2b4r7ga5mnm3v2jg9kd9rs2ei5if.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
